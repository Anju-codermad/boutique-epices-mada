...
-- CreateEnum
CREATE TYPE "CertificationType" AS ENUM ('BIO', 'EQUITABLE');
...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'PAID', 'SHIPPED', 'DELIVERED', 'RETURN_REQUESTED', 'RETURNED', 'REFUNDED', 'CANCELLED');
...
CREATE TABLE "OrderItem" (
    ...
    "unitPriceTtcCents" INTEGER NOT NULL,
